...
class FormRowAction implements RowActionInterface
{
    public const FORM_ACTION = true;
     ...
     */
    public function __construct($title, $route, array $params = [], $confirm = false, $target = '_self', array $attributes = [], $role = null, string $method = 'POST')
    {
        $this->title = $title;
        $this->route = $route;
        $this->params = $params;
